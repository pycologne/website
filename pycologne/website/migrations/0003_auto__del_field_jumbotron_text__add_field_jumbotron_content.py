...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Jumbotron.text'
        db.delete_column(u'cmsplugin_jumbotron', 'text')

        # Adding field 'Jumbotron.content'
        db.add_column(u'cmsplugin_jumbotron', 'content',
                      self.gf('djangocms_text_ckeditor.fields.HTMLField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Jumbotron.text'
        db.add_column(u'cmsplugin_jumbotron', 'text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Jumbotron.content'
        db.delete_column(u'cmsplugin_jumbotron', 'content')
    ...
    models = {
        ...
        u'website.jumbotron': {
            ...
            'button_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
